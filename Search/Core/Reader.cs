...
public static class Reader
{
    ...
    public static async void Toggle(Tab tab, Action<bool> done)
    {
        if (tab.IsBlank)
        {
            done(false);
        ...
        var answer = await tab.Eval(Script);
        var worked = answer is { ValueKind: JsonValueKind.String } a && a.GetString() == "read";
        if (worked) tab.Reader = true;
        done(worked);
    }
    ...
    (function () {
      ...
      sheet.textContent = [
        ...
        '#office-reader h1{font:600 30px/1.24 "Segoe UI Variable Display","Segoe UI",system-ui,sans-serif;',
        'margin:0 0 8px;letter-spacing:-0.01em}',
        '#office-reader .office-from{font:400 12px/1 "Segoe UI Variable Text","Segoe UI",system-ui,sans-serif;color:#a3a3a3;',
        ...
        '#office-reader figcaption{font:400 13px/1.5 "Segoe UI Variable Text","Segoe UI",system-ui,sans-serif;',
        'color:#a3a3a3;margin-top:.6em}',
        '#office-reader a{color:#171717;text-underline-offset:3px}',
        '#office-reader h2,#office-reader h3{font:600 20px/1.3 "Segoe UI Variable Text","Segoe UI",system-ui,sans-serif;',
        'margin:2em 0 .6em}',
        '#office-reader pre,#office-reader code{font-family:ui-monospace,"Cascadia Mono",Consolas,monospace;font-size:14px}',
