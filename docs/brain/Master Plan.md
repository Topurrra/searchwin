...
| **2** ✅ | **The universal field** (2026-09-26: done — six rounds, reviewed four times, every high and medium finding fixed; checked by hand on the AOT build; see [[Log/2026-09-26]]) | Converters, bangs/custom commands, files + apps from the engine index, clipboard history + secret guard, open files in tabs, search://play media route. | 3–4 wks |
| **3** | **Tools as pages + FFmpeg pack — implemented, follow-ups open** (2026-09-27: done — 5 builders, 32 tools across 8 packs, restyled with Search tokens, packs framework verified, FFmpeg pack shipped; merged, tested, installer built; see [[Log/2026-09-27]]) | Packs framework (Settings › Packs: download, verify, update, remove) and the **FFmpeg pack** (LGPL BtbN build; the player plays MKV/AVI/… by remuxing, subtitles; media tools). Tool pages pack by pack: Utilities → Files (file manager) → Privacy → Images → Documents (without Word ⇄ PDF) → Dev → Media → Focus, each restyled and tested. 32 tools shipped (Utilities 7, Files 6, Privacy 3, Images 5, Documents 5, Dev 11, Media 2, Focus 3); Screen Recorder hidden; Word ⇄ PDF deferred to phase 4. Installer: 31 MB with WebView2 bootstrapper | 4–8 wks |
| **4** | **Voice + background + Word ⇄ PDF** | Vosk pack, push-to-talk everywhere, safety gate, tray mode, snippets, global hotkeys; **Word ⇄ PDF** through Word silently, else LibreOffice (Settings offers LibreOffice as a download) — moved here from phase 3 (user, 2026-09-26) | 3–4 wks |
