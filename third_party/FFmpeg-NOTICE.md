...
| Build | BtbN/FFmpeg-Builds, `win64-lgpl-shared-8.1`, pinned autobuild release `autobuild-2026-08-31-13-27`: https://github.com/BtbN/FFmpeg-Builds/releases/tag/autobuild-2026-08-31-13-27 |
...
The licence text travels with the pack (`LICENSE.txt`, the GNU LGPL v3).
Settings › Packs links to the [licence at the exact FFmpeg source commit](https://github.com/FFmpeg/FFmpeg/blob/1a748fe2cd43e3ead22fafb1b5b7d77f153898a8/COPYING.LGPLv3)
before download, and to the build and source.
